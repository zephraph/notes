...
- To create a new order on [[Exchange]]:
    - ```Order.create!(
  state: 'pending',  
  currency_code: 'USD',		  
...
- Did [another PR](https://github.com/artsy/exchange/pull/565) to rename the fraud field in [[Exchange]] from `considered_fraudulent` to `flagged_as_fraud`
