...
- There was a [production incident](https://artsy.slack.com/archives/C02BC3HEJ/p1582557643007000) in which search was broken due to some bundle splitting path issues
    - [[Chris Pappas]] put in a [PR](https://github.com/artsy/force/pull/5110) to  hardcode the CDN paths in [[Force]] which replaced the docker envs that I added via [this PR](https://github.com/artsy/force/pull/5106).
