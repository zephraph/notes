...
function getDailyNoteSettings() {
  ...
  try {
    ...
    var _g = window.app,
      internalPlugins = _g.internalPlugins,
      plugins = _g.plugins
    var dailyNoteSettings =
      (_b =
        (_a = internalPlugins.getPluginById('daily-notes')) === null ||
        _a === void 0
          ? void 0
          : _a.instance) === null || _b === void 0
        ? void 0
        : _b.options
    var periodicNotesSettings =
      (_d =
        (_c = plugins.getPlugin('periodic-notes')) === null || _c === void 0
          ? void 0
    ...
    return {
      ...
      folder:
        ((_e = settings.folder) === null || _e === void 0
          ? void 0
          : _e.trim()) || '',
      template:
        ((_f = settings.template) === null || _f === void 0
          ? void 0
          : _f.trim()) || '',
    }
  } catch (err) {
...
function getWeeklyNoteSettings() {
  ...
  try {
    ...
    var calendarSettings =
      (_a = pluginManager.getPlugin('calendar')) === null || _a === void 0
        ? void 0
        : _a.options
    var periodicNotesSettings =
      (_c =
    ...
    if (periodicNotesSettings) {
      return {
        ...
        folder:
          ((_d = periodicNotesSettings.folder) === null || _d === void 0
            ? void 0
            : _d.trim()) || '',
        template:
          ((_e = periodicNotesSettings.template) === null || _e === void 0
            ? void 0
            : _e.trim()) || '',
      }
    }
    ...
    return {
      ...
      folder:
        ((_f = settings.weeklyNoteFolder) === null || _f === void 0
          ? void 0
          : _f.trim()) || '',
      template:
        ((_g = settings.weeklyNoteTemplate) === null || _g === void 0
          ? void 0
          : _g.trim()) || '',
    }
  } catch (err) {
...
function getMonthlyNoteSettings() {
  ...
  try {
    var settings =
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      ((_b =
        (_a = window.app.plugins.getPlugin('periodic-notes')) === null ||
        _a === void 0
          ? void 0
    ...
    return {
      ...
      folder:
        ((_c = settings.folder) === null || _c === void 0
          ? void 0
          : _c.trim()) || '',
      template:
        ((_d = settings.template) === null || _d === void 0
          ? void 0
          : _d.trim()) || '',
    }
  } catch (err) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          path$1 = obsidian__default['default'].normalizePath(
          ...
          return [
            ...
            vault.create(
              ...
              templateContents
                .replace(
                  /{{\s*(date|time)\s*:(.*?)}}/gi,
                  function (_, _timeOrDate, momentFormat) {
...
function getDailyNote(date, dailyNotes) {
  var _a
  return (_a = dailyNotes[getDateUID(date, 'day')]) !== null && _a !== void 0
    ? _a
    : null
}
            ...
            vault.create(
              ...
              templateContents
                ...
                .replace(
                  ...
                  function (_, dayOfWeek, momentFormat) {
...
function getWeeklyNote(date, weeklyNotes) {
  var _a
  return (_a = weeklyNotes[getDateUID(date, 'week')]) !== null && _a !== void 0
    ? _a
    : null
}
function getAllWeeklyNotes() {
  ...
  var weeklyNotesFolder = vault.getAbstractFileByPath(
    obsidian__default['default'].normalizePath(folder)
  )
...
function create_default_slot(ctx) {
  ...
  const out = (i) =>
    transition_out$1(each_blocks[i], 1, 1, () => {
      each_blocks[i] = null
    })
  ...
  return {
    c() {
      ...
      toggle_class(
        div1,
        'active',
        /*selectedId*/ ctx[6] === getDateUID_1$1(/*date*/ ctx[0], 'day')
      )
      toggle_class(
        div1,
        'adjacent-month',
      ...
      if (!mounted) {
        dispose = [
          listen(div1, 'click', function () {
            if (is_function$1(/*onClick*/ ctx[2] && /*click_handler*/ ctx[8]))
          ...
          listen(div1, 'pointerover', function () {
            if (
              is_function$1(
                /*onHover*/ ctx[1] && /*pointerover_handler*/ ctx[10]
              )
            )
...
function add_css$2() {
  ...
  style.textContent =
    '.arrow.svelte-gbeivq.svelte-gbeivq{align-items:center;cursor:pointer;display:flex;justify-content:center;width:24px}.right.svelte-gbeivq.svelte-gbeivq{transform:rotate(180deg)}.arrow.svelte-gbeivq svg.svelte-gbeivq{color:var(--color-arrow);height:16px;width:16px}'
  append(document.head, style)
}
    ...
    m(target, anchor) {
      ...
      if (!mounted) {
        dispose = listen(div, 'click', function () {
          if (is_function$1(/*onClick*/ ctx[0]))
      ...
      if (!mounted) {
        dispose = [
          listen(h3, 'click', function () {
            if (is_function$1(/*resetDisplayedMonth*/ ctx[1]))
  ...
  return {
    c() {
      ...
      toggle_class(
        div1,
        'active',
        /*selectedId*/ ctx[5] === getDateUID_1$1(/*days*/ ctx[1][0], 'week')
      )
    },
    m(target, anchor) {
      insert(target, div1, anchor)
      ...
      if (!mounted) {
        dispose = [
          listen(div1, 'click', function () {
            if (is_function$1(/*onClick*/ ctx[3] && /*click_handler*/ ctx[8]))
          ...
          listen(div1, 'pointerover', function () {
            if (
              is_function$1(
                /*onHover*/ ctx[2] && /*pointerover_handler*/ ctx[10]
              )
            )
  ...
  return {
    ...
    p(ctx, dirty) {
      if (
        ...
        t_value !== (t_value = /*dayOfWeek*/ ctx[23] + '')
      )
        set_data(t, t_value)
    },
    d(detaching) {
...
function instance$6($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props) => {
    if ('localeData' in $$props)
      $$invalidate(16, (localeData = $$props.localeData))
