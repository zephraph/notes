...
var commandConfigPrefixingPlugin_1 = createCommonjsModule(function (
  module,
  exports
) {
  Object.defineProperty(exports, '__esModule', { value: true })
    ...
    return {
      ...
      action(data, context) {
        ...
        if (Buffer.isBuffer(error)) {
          return {
            error: new gitError.GitError(undefined, error.toString('utf-8')),
          }
        }
        return {
          error,
  ...
  class PluginStore {
    ...
    add(plugin) {
      ...
      utils
        .asArray(plugin)
        .forEach(
          (plugin) => plugin && this.plugins.add(utils.append(plugins, plugin))
        )
      return () => {
    ...
    if (block > 0) {
      return {
        ...
        action(_data, context) {
          ...
          function stop() {
            var _a, _b
            ;(_a = context.spawned.stdout) === null || _a === void 0
              ? void 0
              : _a.off('data', wait)
            ;(_b = context.spawned.stderr) === null || _b === void 0
              ? void 0
              : _b.off('data', wait)
          ...
          function kill() {
            stop()
            context.kill(
              new gitPluginError.GitPluginError(
                undefined,
                'timeout',
...
var gitLogger = createCommonjsModule(function (module, exports) {
  ...
  src$2.default.formatters.L = (value) =>
          ...
          return task.onError(
            ...
            (newStdOut) => {
              ...
              logger(
                ...
                utils.objectToString(newStdOut)
              )
              done(
        ...
        return new Promise((done) => {
          ...
          function attemptClose(exitCode, event = 'retry') {
            ...
            if (attempted || stdErr.length || stdOut.length) {
              logger.info(
                `exitCode=%s event=%s rejection=%o`,
                exitCode,
                event,
                rejection
              )
...
var gitExecutor = createCommonjsModule(function (module, exports) {
  ...
  class GitExecutor {
    ...
    chain() {
      return new gitExecutorChain.GitExecutorChain(
        this,
        this._scheduler,
        this._plugins
      )
  ...
  function deleteBranchesTask(branches, forceDelete = false) {
    return {
      ...
      onError({ exitCode, stdOut }, error, done, fail) {
        if (
          !parseBranchDelete.hasBranchDeletionError(String(error), exitCode)
        ) {
          return fail(error)
        }
        done(stdOut)
    ...
    const task = {
      ...
      onError({ exitCode, stdErr, stdOut }, error, _, fail) {
        ...
        throw new gitResponseError.GitResponseError(
          task.parser(
            utils.bufferToString(stdOut),
            utils.bufferToString(stdErr)
          ),
          String(error)
        )
      },
...
var StatusSummary_1 = createCommonjsModule(function (module, exports) {
  ...
  const parsers = new Map([
    parser(
      ...
      (result, file) => utils.append(result.created, file)
    ),
    parser(
      PorcelainFileStatus.NONE,
      PorcelainFileStatus.DELETED,
      (result, file) => utils.append(result.deleted, file)
    ),
    parser(
      PorcelainFileStatus.NONE,
      PorcelainFileStatus.MODIFIED,
      (result, file) => utils.append(result.modified, file)
    ),
    parser(
      PorcelainFileStatus.ADDED,
      PorcelainFileStatus.NONE,
      (result, file) =>
        utils.append(result.created, file) && utils.append(result.staged, file)
    ),
    parser(
      PorcelainFileStatus.ADDED,
      PorcelainFileStatus.MODIFIED,
    ...
    parser(
      ...
      PorcelainFileStatus.NONE,
      (result, file) =>
        utils.append(result.deleted, file) && utils.append(result.staged, file)
    ),
    parser(
      PorcelainFileStatus.MODIFIED,
      PorcelainFileStatus.NONE,
      (result, file) =>
        utils.append(result.modified, file) && utils.append(result.staged, file)
    ),
    parser(
      PorcelainFileStatus.MODIFIED,
      PorcelainFileStatus.MODIFIED,
    ...
    parser(
      PorcelainFileStatus.UNTRACKED,
      PorcelainFileStatus.UNTRACKED,
      (result, file) => utils.append(result.not_added, file)
    ),
    ...conflicts(
      PorcelainFileStatus.ADDED,
      PorcelainFileStatus.ADDED,
  ...
  function splitLine(result, lineStr) {
    ...
    function data(index, workingDir, path) {
      ...
      if (raw !== '##') {
        result.files.push(
          new FileStatusSummary_1.FileStatusSummary(path, index, workingDir)
        )
      }
    }
  }
...
Git.prototype.applyPatch = function (patches) {
  const task = !filterStringOrStringArray(patches)
    ...
    : applyPatchTask(
        asArray(patches),
        getTrailingOptions([].slice.call(arguments, 1))
      )
...
var gitFactory = createCommonjsModule(function (module, exports) {
  ...
  function gitInstanceFactory(baseDir, options) {
    ...
    config.progress &&
      plugins$1.add(plugins.progressMonitorPlugin(config.progress))
    config.timeout && plugins$1.add(plugins.timeoutPlugin(config.timeout))
    plugins$1.add(
      plugins.errorDetectionPlugin(plugins.errorDetectionHandler(true))
    )
...
var ObsidianGit = /** @class */ (function (_super) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 11:
            ...
            if (!trackingBranch) {
              this.displayError(
                'Did not push. No upstream branch is set! See README for instructions',
                10000
              )
              this.setState(PluginState.idle)
              return [2 /*return*/]
            ...
            return [
              4 /*yield*/,
              this.git.diffSummary([currentBranch, trackingBranch]),
            ]
          case 12:
          ...
          case 13:
            ...
            if (pulledFilesLength > 0) {
              this.displayMessage(
                'Pulled ' + pulledFilesLength + ' files from remote'
              )
            }
            _a.label = 14
          case 14:
          ...
          case 18:
            _a.sent()
            this.displayMessage(
              'Pushed ' + remoteChangedFiles_1 + ' files to remote'
            )
            _a.label = 19
          case 19:
            return [3 /*break*/, 21]
  ...
  ObsidianGit.prototype.enableAutoBackup = function () {
    ...
    this.intervalIDBackup = window.setInterval(function () {
      return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.createBackup(true)]
            case 1:
  ...
  ObsidianGit.prototype.enableAutoPull = function () {
    ...
    this.intervalIDPull = window.setInterval(function () {
      return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.pullChangesFromRemote()]
            case 1:
              return [2 /*return*/, _a.sent()]
          }
        })
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.app.vault.adapter.write(this.conflictOutputFile, text),
            ]
          case 1:
            _a.sent()
...
var ChangedFilesModal = /** @class */ (function (_super) {
  ...
  ChangedFilesModal.prototype.onChooseItem = function (item, _) {
    if (
      this.plugin.app.metadataCache.getFirstLinkpathDest(item.path, '') == null
    ) {
