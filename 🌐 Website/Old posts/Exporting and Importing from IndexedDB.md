---
id: 01FCSNVWG0JR6V49MSN5TK3YNZ
url: /posts/export-import-indexeddb
---
...
![[Untitled.png|Screenshot of application tab in devtools showing 3.8 GB of IndexedDB storage being used. ]]
...
![[Untitled 1.png|A preview of the `processed` table created by riverside during recording]]
...
It would have been awful convenient if I could've just clicked a download button from the devtools to grab the database. So far as I'm aware though, that isn't possible. Also, IndexedDB's API is *not* user friendly. Thankfully there are a lot of interface libraries out there and a lot of blog posts on how to use said libraries. 
